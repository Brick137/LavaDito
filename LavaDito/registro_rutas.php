...
<body>
    ...
    <main>
        ...
        <?php
            ...
            generarSelectFurgonetas($conexion, 'furgoneta_id', 'ID de furgoneta', 'Seleccione una furgoneta');
            generarSelectConductores($conexion, 'conductor_id', 'ID de conductor','Seleccione un conductor');
